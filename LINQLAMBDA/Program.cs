        ...
        static void Main(string[] args) {
            ...
            // var r10 = Products.Max(p => p.Price);
             var r10 =
              ...
              Console.WriteLine("R10 Max Price " + r10);
            ...
            Console.WriteLine(" R11 Min Price: " + r11);
            ...
            Console.WriteLine(" R12 Sum Category 1 : " + r12);
            ...
            Console.WriteLine("R13 Average : " + r13);
            ...
            var r14 = (
                from p in Products
                where p.Category.ID == 30
                select p.Price).DefaultIfEmpty().Average();

            Console.WriteLine("Average r14 exception: " + r14);
